...
<div class="container py-5">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-10 text-center">
            <h1 class="display-4 text-primary-custom mb-3 font-heading">Les Pensions</h1>
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body p-4 p-lg-5">
                    <h3 class="h4 mb-4 text-primary-custom font-heading">Les Prestations Incluses</h3>
                    ...
                    <h3 class="h4 mb-4 mt-5 text-primary-custom font-heading">Options Supplémentaires</h3>
                    <ul class="list-unstyled">
                        <li class="mb-3 d-flex align-items-start">
    ...
    <div class="row g-4 mb-5">
        <div class="col-md-4">
            <div class="position-relative overflow-hidden rounded shadow-sm group-hover-zoom">
                <img src="{{ asset('img/pension-1.jpg') }}" onerror="this.src='https://placehold.co/600x400?text=Boxe+Cheval'" class="img-fluid w-100 img-cover-250" alt="Boxe Cheval">
        ...
        <div class="col-md-4">
            <div class="position-relative overflow-hidden rounded shadow-sm group-hover-zoom">
                <img src="{{ asset('img/pension-2.jpg') }}" onerror="this.src='https://placehold.co/600x400?text=Carriere'" class="img-fluid w-100 img-cover-250" alt="Carrière">
                <div class="position-absolute bottom-0 start-0 w-100 bg-dark bg-opacity-50 text-white p-2 text-center">
        ...
        <div class="col-md-4">
            <div class="position-relative overflow-hidden rounded shadow-sm group-hover-zoom">
                <img src="{{ asset('img/pension-3.jpg') }}" onerror="this.src='https://placehold.co/600x400?text=Ecurie'" class="img-fluid w-100 img-cover-250" alt="Écurie">
                <div class="position-absolute bottom-0 start-0 w-100 bg-dark bg-opacity-50 text-white p-2 text-center">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-8 text-center">
            <div class="bg-light p-4 rounded border">
                <h4 class="mb-3 font-heading">Intéressé par nos tarifs ?</h4>
